...
class ValueDateTransformerWithDITest extends DITestBase {

  val instanceBeanName = "defaultValueDateTransformer"
  ...
  private def generateInstance = {
    ...
    instance = ctx.getBean(instanceBeanName).asInstanceOf[ValueDateTransformer]
  }
